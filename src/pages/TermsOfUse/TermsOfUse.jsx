  ...
  return (
    <div className="terms-of-use-container">
      <div className="terms-of-use-content">
        ...
        <p>
          Welcome to Schedule Master! By using Schedule Master ("the Service"),
        ...
        <p>
          ...
          organization, you represent that you have the authority to bind the
        ...
        <ul>
          ...
          <li>
            Engage in any activity that could damage or disrupt the Service.
          </li>
        </ul>
        ...
        <p>
          ...
          and provides users with the ability to schedule and organize their
          academic activities. We may modify or discontinue any aspect of the
          Service at any time.
        </p>
        ...
        <p>
          ...
          the collection and use of your data as described in the Privacy
          Policy.
        </p>
        ...
        <ul>
          <li>
            Use the Service in any manner that could interfere with or damage
            its functionality.
          </li>
